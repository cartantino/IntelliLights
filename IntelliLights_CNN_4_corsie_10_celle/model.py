...
class TrainModel:
    ...
    def _build_model(self, num_layers, width):
        ...
        model.add(layers.Conv2D(8, (2,2), activation='relu', strides=1, input_shape=(8, 10, 3), padding='same'))
        model.add(layers.Conv2D(8, (2,2), activation='relu', strides=1, padding='same'))
    ...
    def predict_batch(self, states):
        ...
        """
        states = states.reshape(self.batch_size, 8 , 10, 3)
